...
public class ReportMonthly extends JFrame implements Printable {
	...
	public ReportMonthly(String register, User user) {
		...
		btnNewButton.setIcon(new ImageIcon(ReportMonthly.class.getResource("/img/imprimir.png")));
		...
		btnNewButton.setBounds(608, 31, 89, 63);
		contentPane.add(btnNewButton);
		
		JButton btnCerrar = new JButton("");
		btnCerrar.setIcon(new ImageIcon(ReportMonthly.class.getResource("/img/puerta-cerrada.png")));
		btnCerrar.setBackground(new Color(0, 102, 255));
		btnCerrar.setBounds(608, 567, 89, 63);
		...
		lblNewLabel_4.setBounds(600, 3, 1, 643);
