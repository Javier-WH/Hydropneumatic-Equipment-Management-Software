	...
	public RegisterCompresorFrame() {
		...
		}
		{
			...
			}
			{
				...
				btnRetorePicture.setIcon(new ImageIcon(RegisterCompresorFrame.class.getResource("/img/tiempo-pasado.png")));
				btnRetorePicture.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						putPlaceHolderPicture();
					}
				});
				btnRetorePicture.setBounds(34, 302, 232, 37);
...
///end consturctor 
	...
	public RegisterCompresorFrame(ResultSet equipament) {
		setResizable(false);
		setAlwaysOnTop(true);
		setIconImage(Toolkit.getDefaultToolkit().getImage(RegisterCompresorFrame.class.getResource("/img/icono.png")));
		setTitle("Actualizar Compresor");
					...
					public void actionPerformed(ActionEvent e) {
						...
						if (areDataComplete()) {
							...
							if(isRegistered) {
								...
								JOptionPane.showMessageDialog(contentPanel, "Ocurrió un error al intentar actualizar el equipo", "ERROR", JOptionPane.ERROR_MESSAGE);
							}
		...
		try {
			...
			textMaxPresure.setText(equipament.getString("max_presure"));
			textFrecuency.setText(equipament.getString("frecuency"));
			textRotationSpeed.setText(equipament.getString("rotation_speed"));
			textTension.setText(equipament.getString("tension_power"));
			textEnviromentTemp.setText(equipament.getString("enviroment_temp"));
