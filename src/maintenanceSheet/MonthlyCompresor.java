...
public class MonthlyCompresor extends JPanel {
	private static JTextField textCode = new JTextField();


	public MonthlyCompresor() {
		...
		JLabel lbl1 = new JLabel("Inspección táctil para determinar vibraciones excesivas");
		...
		chckbx1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(chckbx1.isSelected()) {
					Sheet.setMonthlyCompresorVTCT(new GetFormatedDate().getDate());
				}else {
					Sheet.setMonthlyCompresorVTCT("");
				}
			}
		});
		...
		JLabel lbl2 = new JLabel("Medición de consumo eléctrico ");
		...
		chckbx2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(chckbx2.isSelected()) {
					Sheet.setMonthlyCompresorVNA(new GetFormatedDate().getDate());
				}else {
					Sheet.setMonthlyCompresorVNA("");
				}
			}
		});
		...
		textCode.addKeyListener(new KeyAdapter() {
			...
			public void keyReleased(KeyEvent e) {
				Sheet.setMonthlyCompresorCode(textCode.getText());
			}
		});
